...
function ProductTag({
  ...
  return (
    <div className="border-gray relative m-3 h-96 w-48 cursor-pointer rounded-xl border-2 bg-white hover:shadow-lg">
      ...
      <img src={image} className="size-48 rounded-xl object-contain" />
